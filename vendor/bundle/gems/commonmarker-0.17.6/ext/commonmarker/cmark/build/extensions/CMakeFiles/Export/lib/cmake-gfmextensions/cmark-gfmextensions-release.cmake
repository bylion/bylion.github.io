...
set_target_properties(libcmark-gfmextensions PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcmark-gfmextensions.so.0.28.3.gfm.11"
  IMPORTED_SONAME_RELEASE "libcmark-gfmextensions.so.0.28.3.gfm.11"
  )

list(APPEND _IMPORT_CHECK_TARGETS libcmark-gfmextensions )
list(APPEND _IMPORT_CHECK_FILES_FOR_libcmark-gfmextensions "${_IMPORT_PREFIX}/lib/libcmark-gfmextensions.so.0.28.3.gfm.11" )
