...
set_target_properties(libcmark-gfm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcmark-gfm.so.0.28.3.gfm.11"
  IMPORTED_SONAME_RELEASE "libcmark-gfm.so.0.28.3.gfm.11"
  )

list(APPEND _IMPORT_CHECK_TARGETS libcmark-gfm )
list(APPEND _IMPORT_CHECK_FILES_FOR_libcmark-gfm "${_IMPORT_PREFIX}/lib/libcmark-gfm.so.0.28.3.gfm.11" )
